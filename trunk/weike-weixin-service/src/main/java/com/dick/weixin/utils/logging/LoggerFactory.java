package com.dick.weixin.utils.logging;

import java.util.concurrent.locks.ReadWriteLock;
import java.util.concurrent.locks.ReentrantReadWriteLock;

import com.dick.weixin.utils.logging.jdk.JdkLoggerFactory;
/**
		...
		try {
			if (factory == null) {
				try {
					...
					factory = new com.dick.weixin.utils.logging.commons.CommonsLoggerFactory();
